...
geo-message = Отправьте свой город или город, в часовом поясе которого вы находитесь, в формате: <b>"Страна, регион, населенный пункт"</b>
              Либо отправьте ваш часовой пояс в формате: <b>"+ЧЧ:ММ"</b>
              Например: <b>"+03:00"</b>

              Это необходимо для автоматического сброса калорий к нулю при наступлении следующих суток.
